...
public class TagServiceTest {
    ...
    private final TagService tagService = new TagService(tagDao);
    ...
    public void testShouldWorkCorrectlyInCreateTagsIfNotPresent() {
        ...
        Mockito.when(tagDao.create(anyObject())).thenReturn(tagId);

        List<Long> actualAutoGeneratedIds = tagService.createTagsIfNotPresent(tags);
